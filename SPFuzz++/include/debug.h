...
#define LOGTRACE(x...) do { \
    FILE * tracef = fopen(TRACEFILE, "a+"); \
    fprintf(tracef, x);\
    fclose(tracef);\
  } while (0)
#else
// disable debugging part to save resources
#define LOGTRACE(x...) (void)0
