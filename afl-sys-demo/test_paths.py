...
samples_paths = ["/data/xjf/relationTest-gzip/afl-sys-inputs/", 
...
old_target_app = "/home/xjf/gzipTest/gzip-1.12/aflbuild/gzip"
other_args = " -c -d -k "

record_paths = ["/data/xjf/relationTest-gzip/afl-sys-paths.txt", 
